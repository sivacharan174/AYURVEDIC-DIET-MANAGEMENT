...
/**
 * Displays all Medical History records in RecyclerView cards.
 * Click on a card to see full details.
 */
public class MedicalHistoryViewActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tvNoDataTitle != null)
            tvNoDataTitle.setText("No medical history yet");
        ...
        if (btnAddNew != null)
            btnAddNew.setText("➕ Add Medical History");
    ...
    private void addItem(JSONObject data) {
        try {
            ...
            item.setDataType("Medical History");
            ...
            if (!conditions.isEmpty() && !conditions.equals("null")) {
                summary = conditions.length() > 40 ? conditions.substring(0, 40) + "..." : conditions;
            }
